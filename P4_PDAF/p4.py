...
ax1.plot(xs_clutterPDAF[:,0], 'y', label='cluttered PDAF')
...
ax1.plot(xs_clutterPDAF[:,2], 'y', label='cluttered PDAF')
ax1.set(xlabel="Time (s)")
...
ax1.plot(xs_clutterPDAF[:,4], 'y', label='cluttered PDAF')
ax1.set(xlabel="Time (s)")
